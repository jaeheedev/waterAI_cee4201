...
def main():
    ...
    print("gwang")
    gwang_plot = Plot_timeseries('./rawdata/test/gwang22.csv', './preprocessing/test/revised_gwang22.csv')
    gwang_plot.output_file_test()

    print("choeng")
    cheong_plot = Plot_timeseries('./rawdata/test/cheong22.csv', './preprocessing/test/revised_cheong22.csv')
    cheong_plot.output_file_test()

    print('haeng')
    haeng_plot = Plot_timeseries('./rawdata/test/haeng22.csv', './preprocessing/test/revised_haeng22.csv')
    haeng_plot.output_file_test()

    print('pal')
    pal_plot = Plot_timeseries('./rawdata/test/pal22.csv', './preprocessing/test/revised_pal22.csv')
